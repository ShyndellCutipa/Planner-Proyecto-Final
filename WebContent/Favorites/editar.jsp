        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title">Nuevo Favorito</h3> 
                            <!-- DO MAGIC HERE -->
                            
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="AdminFavorite?action=actualizar" method="post">
                                    	<div class="form-group">
                                            <label for="exampleInputuname">ID</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-hashtag"></i></div>
                                                <input type="text" class="form-control" name="id_fav" value="${favorito.id_fav}" id="id_fav" readonly>
                                        	</div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name" value="${favorito.name}" placeholder="Escriba el nombre"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputuname">Referencia</label>
                                            <div class="input-group">
                                                <div class="input-group-addon" ><i class="fa fa-font"></i></div>
                                                <input type="text" class="form-control"  name="reference" id="reference" value="${favorito.reference}" placeholder="Referencia"> </div>
                                        </div>
                                      	<div class="form-group">
                                            <label for="exampleInputuname">Comentario</label>
                                            <div class="input-group">
                                                <div class="input-group-addon" ><i class="fa fa-commenting-o"></i></div>
                                                <input type="text" class="form-control"  name="comment" id="comment" value="${favorito.comment}" placeholder="Comentario"> </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-star"></i></div>
                                                  <select name="category" id="category" class="form-control">
		                                            <option value="Libro" ${favorito.category =='Libro' ? 'selected' : '' }>Libro</option>
		                                            <option value="Pelicula" ${favorito.category =='Pelicula' ? 'selected' : '' }>Pelicula</option>
		                                            <option value="Lugar" ${favorito.category =='Lugar' ? 'selected' : '' }>Lugar</option>
		                                            <option value="Restaurante" ${favorito.category =='Restaurante' ? 'selected' : '' }>Restaurante</option>
		                                            <option value="Serie" ${favorito.category =='Serie' ? 'selected' : '' }>Serie</option>
		                                            <option value="Ropa" ${favorito.category =='Ropa' ? 'selected' : '' } >Ropa</option>
                                        			</select>
                                        		</div>
                                        </div>
                                     
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Guardar</button>
                                        <button type="submit" onclick="form.action='AdminFavorite?action=mostrar'" class="btn btn-inverse waves-effect waves-light">Cancelar</button>
                                    </form>
                                </div>
