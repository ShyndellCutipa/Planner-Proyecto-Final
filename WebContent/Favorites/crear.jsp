                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="AdminFavorite?action=crear" method="post">
                                        <div class="form-group">
                                            <label for="exampleInputuname">Nombre</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-bookmark"></i></div>
                                                <input type="text" class="form-control" name="name" id="name" placeholder="Escriba el nombre"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputuname">Referencia</label>
                                            <div class="input-group">
                                                <div class="input-group-addon" ><i class="fa fa-font"></i></div>
                                                <input type="text" class="form-control"  name="reference" id="reference" placeholder="Referencia"> </div>
                                        </div>
                                      	<div class="form-group">
                                            <label for="exampleInputuname">Comentario</label>
                                            <div class="input-group">
                                                <div class="input-group-addon" ><i class="fa fa-commenting-o"></i></div>
                                                <input type="text" class="form-control"  name="comment" id="comment" placeholder="Comentario"> </div>
                                        </div>
                                        <div class="form-group">
