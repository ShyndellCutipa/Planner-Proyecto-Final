                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="AdminTask?action=actualizar" method="post">
                                        <div class="form-group">
                                            <label for="exampleInputuname">ID</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-bookmark"></i></div>
                                                <input type="text" class="form-control" name="id_task" id="id_task" value="${tarea.id_task}" placeholder="Escriba un Título" readonly> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputuname">Título</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-bookmark"></i></div>
                                                <input type="text" class="form-control" name="title" id="title" value="${tarea.title}" placeholder="Escriba un Título"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputuname">Descripción</label>
                                            <div class="input-group">
                                                <div class="input-group-addon" ><i class="fa fa-font"></i></div>
                                                <input type="text" class="form-control"  name="description" id="description" value="${tarea.description}" placeholder="Descripción"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputDate">Fecha</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-calendar-plus-o"></i></div>
                                                <input type="date" class="form-control" name="due_date" id="due_date" value="${tarea.due_date}" placeholder="Seleccione Fecha"> </div>
                                        </div>
                                        <div class="form-group">
