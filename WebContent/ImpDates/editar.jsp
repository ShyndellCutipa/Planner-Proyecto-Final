        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title">Editar Fecha Importante</h3> 
                            <!-- DO MAGIC HERE -->
                            
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="AdminImportantDate?action=actualizar" method="post">
                                    	<div class="form-group">
                                            <label for="exampleInputuname">ID</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-hashtag"></i></div>
                                                <input type="text" class="form-control" name="id_date" id="id_date" value="${fecha_importante.id_date}" placeholder="Escriba un Título" readonly> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputuname">Título</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-bookmark"></i></div>
                                                <input type="text" class="form-control" name="title" id="title" value="${fecha_importante.title}" placeholder="Escriba un Título"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Fecha</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-calendar-plus-o"></i></div>
                                                <input type="date" class="form-control" name="due_date" id="due_date" value="${fecha_importante.due_date}" placeholder="Seleccione Fecha"> </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-arrows-v"></i></div>
                                                  <select name="priority" id="priority" class="form-control">
		                                            <option value="Bajo" ${fecha_importante.priority =='Bajo' ? 'selected' : '' }>Bajo</option>
		                                            <option value="Medio"${fecha_importante.priority == 'Medio' ? 'selected': '' }>Medio</option>
		                                            <option value="Alto" ${fecha_importante.priority == 'Alto' ? 'selected': '' }>Alto</option>
                                        		  </select>
                                        		</div>
                                        </div>
                                     
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Actualizar</button>
                                        <button type="submit" onclick="form.action='AdminImportantDate?action=mostrar'" class="btn btn-inverse waves-effect waves-light">Cancelar</button>
                                    </form>
                                </div>
