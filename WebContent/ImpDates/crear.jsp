        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title">Nueva Fecha Importante</h3> 
                            <!-- DO MAGIC HERE -->
                            
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="AdminImportantDate?action=crear" method="post">
                                        ...
                                        <button type="submit" name="btn-action" class="btn btn-success waves-effect waves-light m-r-10">Guardar</button>
                                        <button type="submit" name="btn-action"  onclick="form.action='AdminImportantDate?action=mostrar'" class="btn btn-inverse waves-effect waves-light">Cancelar</button>
                                    </form>
                                </div>
