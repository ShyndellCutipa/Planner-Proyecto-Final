			                            ...
			                            <div class="user-bg"> <img width="100%" alt="user" src="#">
			                                <div class="overlay-box">
			                                    <div class="user-content">
			                                        <a href="javascript:void(0)"><img src="assets/plugins/images/users/genu.jpg" class="thumb-lg img-circle" alt="img"></a>
			                    ...
			                    <div class="col-md-6 col-xs-12">
			                        <div class="white-box">
			                        	<ul class="nav nav-tabs tabs customtab">
											<li class="active tab">
                                    			<a href="#profile" data-toggle="tab"> <span class="invisible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">Perfil</span></a><br>
                                				<p><a  class="btn btn-default btn-circle" ><i class="fa fa-user"></i></a> Usuario: ${user.username}</p>
                                				<p><a  class="btn btn-default btn-circle" ><i class="fa fa-moon-o"></i></a> Nombre: ${user.first_name} ${user.last_name}</p>
                                				<p><a  class="btn btn-default btn-circle" ><i class="fa fa-envelope"></i></a> Correo: ${user.email}</p>
                                			</li>
                                		</ul>
			                            </div>
			                        </div>
