...
<head>
    ...
    <meta name="description" content="Pixel Admin Lite Free Vesion is powerful and clean admin dashboard template, inpired from Bootstrap Framework">
    <meta name="robots" content="noindex,nofollow">
    <title>Pixel Admin Lite Free Version Template by WrapPixel</title>
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="Inicio/index.jsp" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Retornar a Inicio</a> </div>
            <footer class="footer text-center">2020 © My Planner</footer>
        </div>
    </section>
    <!-- jQuery -->
