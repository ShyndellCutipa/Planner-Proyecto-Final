...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample05">
          <ul class="navbar-nav pl-md-5">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="about.jsp">Informacion</a>
            </li>
  ...
  <section class="home-slider inner-page owl-carousel">
    <div class="slider-item" style="background-image: url('images/slider-plannerbg2.jpg');">

      <div class="container">
        <div class="row slider-text align-items-center justify-content-center">
          <div class="col-md-8 text-center col-sm-12 element-animate">
            <h1>Acerca de nosotros</h1>
            <p class="mb-5 sub-text">Somos estudiantes de segundo año de la escuela profesional de ciencias de la
              computacion de la Universidad Nacional de San Agustin</p>
            <p><a href="#" class="btn btn-white btn-outline-white px-4 py-3">Mas</a></p>
          </div>
        </div>
      </div>
  ...
  <section>
    <div class="half d-lg-flex d-block">
      <div class="image" style="background-image: url('images/plannerbg2.jpg')"></div>
      <div class="text text-center element-animate">
        <h3 class="mb-4">Nuestro obejtivo</h3>
        <p class="mb-5">A traves de esta pagina web queremos intentar gestionar mejor su valioso tiempo especialmente en
          personas que realizan algun tipo de estudios</p>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5 element-animate">
        <div class="col-md-8 text-center">
          <h2 class="heading mb-4">Nuestro Equipo</h2>
          <p class="mb-5 lead">Nuestro equipo esta conformado por dos personas:</p>
        </div>
      </div>
        ...
        <div class="nonloop-block-11 owl-carousel">
          <div>
            <div class="media d-block media-custom text-center">
              <a href="adoption-single.html"><img src="images/person_1.jpg" alt="Image Placeholder"
                  class="img-fluid"></a>
              <div class="media-body">
                <h3 class="mt-0 text-black">Shyndell Cutipa</h3>
              </div>
            </div>
          </div>
          <div>
            <div class="media d-block media-custom text-center">
              <a href="adoption-single.html"><img src="images/person_2.jpg" alt="Image Placeholder"
                  class="img-fluid"></a>
              <div class="media-body">
                <h3 class="mt-0 text-black">Alvaro Ticona</h3>
              </div>
            </div>
          </div>
        </div>
